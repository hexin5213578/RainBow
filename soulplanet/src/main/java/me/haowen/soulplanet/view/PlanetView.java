...
public class PlanetView extends View {
    ...
    public static final int COLOR_T = 0xFF6363;
    public static final int COLOR_P = 0xFFC163;
    public static final int COLOR_BAOMI = 0xFFFFFF;
    public static final int COLOR_H = 0x64CCFF;
    public static final int COLOR_BI = 0xFFEA63;
