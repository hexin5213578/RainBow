 ...
 */
public class XingweiActivity extends BaseAvtivity {
    ...
    protected int getResId() {
        return R.layout.activity_xingwei;
    }

    @Override
    protected void getData() {
        StatusBarUtil.setGradientColor(XingweiActivity.this,toolbar);
        StatusBarUtil.setDarkMode(XingweiActivity.this);
