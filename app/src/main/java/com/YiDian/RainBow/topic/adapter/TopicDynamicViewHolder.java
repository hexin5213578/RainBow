...
public class TopicDynamicViewHolder extends RecyclerView.ViewHolder {
    ...
    public TopicDynamicViewHolder(Context context, View itemView) {
        super(itemView);
    ...
    public static TopicDynamicViewHolder createViewHolder(Context context,
                                                          ViewGroup parent, int layoutId) {
        View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                false);
        return new TopicDynamicViewHolder(context, itemView);
    }
}
