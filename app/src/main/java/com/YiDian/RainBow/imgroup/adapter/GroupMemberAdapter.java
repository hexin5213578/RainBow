...
public class GroupMemberAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<GroupMemberBean.ObjectBean.ListBean> list;
    private GroupMemberBean.ObjectBean.ListBean listBean;
    ...
    public void setData(List<GroupMemberBean.ObjectBean.ListBean> list) {
        this.list = list;
    }
