...
public class GroupMyCreateAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<MyCreateGroupMsgBean.ObjectBean> list;
    private MyCreateGroupMsgBean.ObjectBean listbean;

    public GroupMyCreateAdapter(Context context, List<MyCreateGroupMsgBean.ObjectBean> list) {
