...
public class MydraftViewHolderTextAndImg extends RecyclerView.ViewHolder {

    private  Context context;
    private  View itemView;

    public MydraftViewHolderTextAndImg(Context context, View itemView) {
        super(itemView);
    ...
    public static MydraftViewHolderTextAndImg createViewHolder(Context context,
                                                               ViewGroup parent, int layoutId) {
        View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                false);
        return new MydraftViewHolderTextAndImg(context, itemView);
    }
}
