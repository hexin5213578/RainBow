...
public class MyDynamicViewHolderVideoAndText extends RecyclerView.ViewHolder {

    private  Context context;
    private  View itemView;

    public MyDynamicViewHolderVideoAndText(Context context, View itemView) {
        super(itemView);
    ...
    public static MyDynamicViewHolderVideoAndText createViewHolder(Context context,
                                                                   ViewGroup parent, int layoutId) {
        View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                false);
        return new MyDynamicViewHolderVideoAndText(context, itemView);
    }
}
