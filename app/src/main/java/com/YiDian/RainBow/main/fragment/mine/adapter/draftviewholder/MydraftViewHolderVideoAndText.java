...
public class MydraftViewHolderVideoAndText extends RecyclerView.ViewHolder {
    ...
    public MydraftViewHolderVideoAndText(Context context, View itemView) {
        super(itemView);
    ...
    public static MydraftViewHolderVideoAndText createViewHolder(Context context,
                                                                 ViewGroup parent, int layoutId) {
        View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                false);
        return new MydraftViewHolderVideoAndText(context, itemView);
    }
}
