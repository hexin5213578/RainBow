...
public class MyDynamicViewHolderTextAndImg extends RecyclerView.ViewHolder {

    private  Context context;
    private  View itemView;

    public MyDynamicViewHolderTextAndImg(Context context, View itemView) {
        super(itemView);
    ...
    TextView tvTopic;
    public static MyDynamicViewHolderTextAndImg createViewHolder(Context context,
                                                                 ViewGroup parent, int layoutId) {
        View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                false);
        return new MyDynamicViewHolderTextAndImg(context, itemView);
    }
}
