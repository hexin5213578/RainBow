...
public class MyDynamicViewHolderText extends RecyclerView.ViewHolder {

    private  Context context;
    private  View itemView;

    public MyDynamicViewHolderText(Context context, View itemView) {
        super(itemView);
    ...
    TextView tvTopic;
    public static MyDynamicViewHolderText createViewHolder(Context context,
                                                           ViewGroup parent, int layoutId) {
        View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                false);
        return new MyDynamicViewHolderText(context, itemView);
    }
}
