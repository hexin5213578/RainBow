...
public class ViewHolderImg extends RecyclerView.ViewHolder {
    ...
    public ViewHolderImg(Context context, View itemView) {
        super(itemView);
    ...
    TextView tvTopic;
    public static ViewHolderImg createViewHolder(Context context,
                                                 ViewGroup parent, int layoutId) {
        View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                false);
        return new ViewHolderImg(context, itemView);
    }
}
