...
public class MyDynamicViewHolderImg extends RecyclerView.ViewHolder {

    private  Context context;
    private  View itemView;

    public MyDynamicViewHolderImg(Context context, View itemView) {
        super(itemView);
    ...
    public static MyDynamicViewHolderImg createViewHolder(Context context,
                                                          ViewGroup parent, int layoutId) {
        View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                false);
        return new MyDynamicViewHolderImg(context, itemView);
    }
}
