...
public class ViewHolderTextandimg extends RecyclerView.ViewHolder {

    private  Context context;
    private  View itemView;

    public ViewHolderTextandimg(Context context, View itemView) {
        super(itemView);
    ...
    public static ViewHolderTextandimg createViewHolder(Context context,
        ...
        View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                false);
        return new ViewHolderTextandimg(context, itemView);
    }
}
